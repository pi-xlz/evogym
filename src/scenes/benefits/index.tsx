...
// could also be typed like so😕 => const benefits: Array<BenefitType> = [{...},..]
const benefits: BenefitType[] = [
  {
    icon: <HomeModernIcon className="h-6 w-6" />,
    title: "State of the Art Facilities",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio hic quaerat consequatur odit rerum fugit?,",
  },
  {
